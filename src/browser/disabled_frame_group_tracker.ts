...
function getLeaderDelta(win: OpenFinWindow, bounds: Partial<RectangleBase>): RectangleBase {
...
function handleBoundsChanging(win: OpenFinWindow, rawBounds: RectangleBase, changeType: ChangeType): Move[] {
